...
define(['exports', './RuntimeError-c581ca93', './defaultValue-94c3e563', './Transforms-a076dbe6', './ComponentDatatype-4a60b8d6'], (function (exports, RuntimeError, defaultValue, Transforms, ComponentDatatype) { 'use strict';
  ...
  Color.lerp = function (start, end, t, result) {
    ...
    result.green = ComponentDatatype.CesiumMath.lerp(start.green, end.green, t);
    result.blue = ComponentDatatype.CesiumMath.lerp(start.blue, end.blue, t);
    result.alpha = ComponentDatatype.CesiumMath.lerp(start.alpha, end.alpha, t);
    return result;
  };
