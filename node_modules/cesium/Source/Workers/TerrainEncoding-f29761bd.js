...
define(['exports', './Transforms-a076dbe6', './Matrix2-fc7e9822', './RuntimeError-c581ca93', './defaultValue-94c3e563', './AttributeCompression-4d18cc04', './ComponentDatatype-4a60b8d6'], (function (exports, Transforms, Matrix2, RuntimeError, defaultValue, AttributeCompression, ComponentDatatype) { 'use strict';
  ...
  const scratchCameraPositionInScaledSpaceShrunk = new Matrix2.Cartesian3();
  ...
  function getPossiblyShrunkEllipsoid(ellipsoid, minimumHeight, result) {
    if (
      ...
      const ellipsoidShrunkRadii = Matrix2.Cartesian3.fromElements(
  ...
  function isScaledSpacePointVisible(
    ...
    const vt = Matrix2.Cartesian3.subtract(
      occludeeScaledSpacePosition,
      cv,
      scratchCartesian
    );
    const vtDotVc = -Matrix2.Cartesian3.dot(vt, cv);
  ...
  const scaledSpaceScratch = new Matrix2.Cartesian3();
  const directionScratch = new Matrix2.Cartesian3();
  ...
  const directionToPointScratch = new Matrix2.Cartesian3();
  ...
  const scratchCartographic = new Matrix2.Cartesian3();
  ...
  const cartesian3DimScratch = new Matrix2.Cartesian3();
  ...
  function TerrainEncoding(
    ...
    if (
      ...
      const dimensions = Matrix2.Cartesian3.subtract(
        maximum,
        minimum,
  ...
  const scratchGeodeticSurfaceNormal = new Matrix2.Cartesian3();
